...
if (!file.exists('C:/Personal/coursera-data-science/Getting and Cleaning Data/Project/UCI HAR Dataset.zip')){
  download.file(fileurl,'C:/Personal/coursera-data-science/Getting and Cleaning Data/Project/UCI HAR Dataset.zip', mode = 'wb')
